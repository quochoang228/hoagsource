...
import '../clipper/rect_clipper.dart';
import '../target/target_position.dart';

class TutorialLightPaintRect extends CustomPainter {
  final double progress;
  final TutorialTargetPosition target;
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawPath(
      radius > 0
          ? TutorialRectClipper.rRectHolePath(size, x, y, w, h, radius)
          : TutorialRectClipper.rectHolePath(size, x, y, w, h),
      Paint()
  ...
  @override
  bool shouldRepaint(TutorialLightPaintRect oldDelegate) {
