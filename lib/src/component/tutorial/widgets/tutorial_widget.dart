...
class TutorialkWidget extends StatefulWidget {
  const TutorialkWidget({
    super.key,
  ...
  @override
  TutorialkWidgetState createState() => TutorialkWidgetState();
}

class TutorialkWidgetState extends State<TutorialkWidget>
    implements TutorialCoachMarkController {
  final GlobalKey<TutorialAnimatedFocusLightState> _focusLightKey = GlobalKey();
  bool showContent = false;
  TutorialTargetFocus? currentTarget;
  ...
  Widget _buildContents() {
    ...
    children = currentTarget!.contents!.map<Widget>((i) {
      switch (i.align) {
        case TutorialContentAlign.bottom:
          {
        ...
        case TutorialContentAlign.top:
          ...
          break;
        case TutorialContentAlign.left:
          {
          ...
          break;
        case TutorialContentAlign.right:
          {
          ...
          break;
        case TutorialContentAlign.custom:
          {
