...
//         return context.baseThem?.accordionTheme.sizes.sm ?? BaseAccordionSizes(tokens: BaseTokens.light).sm;
//       case BaseAccordionSize.md:
//         return context.baseThem?.accordionTheme.sizes.md ?? BaseAccordionSizes(tokens: BaseTokens.light).md;
//       case BaseAccordionSize.lg:
//         return context.baseThem?.accordionTheme.sizes.lg ?? BaseAccordionSizes(tokens: BaseTokens.light).lg;
//       case BaseAccordionSize.xl:
//         return context.baseThem?.accordionTheme.sizes.xl ?? BaseAccordionSizes(tokens: BaseTokens.light).xl;
//       default:
//         return context.baseThem?.accordionTheme.sizes.md ?? BaseAccordionSizes(tokens: BaseTokens.light).md;
//     }
//   }
...
//         widget.iconColor ?? context.baseThem?.accordionTheme.colors.trailingIconColor ?? BaseTokenColors.light.textSecondary;
//
//     final Color effectiveExpandedTrailingIconColor =
//         widget.expandedIconColor ?? context.baseThem?.accordionTheme.colors.expandedTrailingIconColor ?? BaseTokenColors.light.textPrimary;
//
...
//     final Color effectiveBorderColor = widget.borderColor ?? context.baseThem?.accordionTheme.colors.borderColor ?? BaseTokenColors.light.beerus;
//
//     final List<BoxShadow> effectiveShadows = widget.shadows ?? context.baseThem?.accordionTheme.shadows.shadows ?? BaseTokenShadows.light.sm;
//
...
//         context.moonEffects?.controlHoverEffect.primaryHoverColor ?? MoonEffectsTheme(tokens: BaseTokens.light).controlHoverEffect.primaryHoverColor;
//
...
//
//     final Color effectiveBackgroundColor = widget.backgroundColor ?? context.baseThem?.accordionTheme.colors.backgroundColor ?? BaseTokenColors.light.goku;
//
//     final Color effectiveExpandedBackgroundColor =
//         widget.expandedBackgroundColor ?? context.baseThem?.accordionTheme.colors.expandedBackgroundColor ?? BaseTokenColors.light.goku;
//
//     final Color effectiveIconColor = widget.iconColor ?? context.baseThem?.accordionTheme.colors.iconColor ?? BaseTokenColors.light.iconPrimary;
//
//     final Color effectiveExpandedIconColor =
//         widget.expandedIconColor ?? context.baseThem?.accordionTheme.colors.expandedIconColor ?? BaseTokenColors.light.iconPrimary;
//
//     final Color effectiveTextColor = widget.textColor ?? context.baseThem?.accordionTheme.colors.textColor ?? BaseTokenColors.light.textPrimary;
//
//     final Color effectiveExpandedTextColor =
//         widget.expandedTextColor ?? context.baseThem?.accordionTheme.colors.expandedTextColor ?? BaseTokenColors.light.textPrimary;
//
//     final Color effectiveContentTextColor = context.baseThem?.accordionTheme.colors.contentColor ?? BaseTokenColors.light.textPrimary;
//
...
//         context.baseThem?.accordionTheme.properties.transitionDuration ??
//         BaseTokenTransitions.transitions.defaultTransitionDuration;
//
//     final Curve effectiveTransitionCurve =
//         widget.transitionCurve ?? context.baseThem?.accordionTheme.properties.transitionCurve ?? BaseTokenTransitions.transitions.defaultTransitionCurve;
//
...
//     final Color effectiveDividerColor = widget.dividerColor ?? context.baseThem?.accordionTheme.colors.dividerColor ?? BaseTokenColors.light.beerus;
//
//     final Duration effectiveTransitionDuration = widget.transitionDuration ??
//         context.baseThem?.accordionTheme.properties.transitionDuration ??
//         BaseTokenTransitions.transitions.defaultTransitionDuration;
