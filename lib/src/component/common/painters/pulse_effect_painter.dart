    ...
    if (!animation.isDismissed) {
      ...
      canvas.drawRRect(
        RRect.fromRectAndCorners(
          ...
          topLeft: BaseSquircleRadius(cornerRadius: topLeftLerp),
          topRight: BaseSquircleRadius(cornerRadius: topRightLerp),
          bottomLeft: BaseSquircleRadius(cornerRadius: bottomLeftLerp),
          bottomRight: BaseSquircleRadius(cornerRadius: bottomRightLerp),
        ),
        paint,
      );
    }
