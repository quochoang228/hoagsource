...
class BaseSquircleRadius extends Radius {
  static const zero = BaseSquircleRadius(
    cornerRadius: 0,
    cornerSmoothing: 0,
  );
  ...
  @override
  Radius operator -() => BaseSquircleRadius(
  ...
  @override
  BaseSquircleRadius operator *(double operand) => BaseSquircleRadius(
  ...
  ///
  /// If either is null, this function substitutes [BaseSquircleRadius.zero]
  /// instead.
  ///
  ...
  static BaseSquircleRadius? lerp(
      BaseSquircleRadius? a,
      BaseSquircleRadius? b,
      double t,
      ) {
    if (b == null) {
      if (a == null) {
  ...
  bool operator ==(Object other) {
    ...
    return other is BaseSquircleRadius &&
