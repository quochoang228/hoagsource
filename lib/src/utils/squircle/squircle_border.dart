...
class BaseSquircleBorder extends OutlinedBorder {
  /// The radius for each corner.
  ///
  /// Negative radius values are clamped to 0.0 by [getInnerPath] and
  /// [getOuterPath].
  final BaseSquircleBorderRadius borderRadius;
  final BorderAlign borderAlign;

  const BaseSquircleBorder({
    super.side = MoonSquicleBorderSide.none,
    this.borderRadius = BaseSquircleBorderRadius.zero,
  ...
  ShapeBorder? lerpFrom(ShapeBorder? a, double t) {
    if (a is BaseSquircleBorder) {
      return BaseSquircleBorder(
        side: MoonSquicleBorderSide.lerp(a.side, side, t),
        borderRadius: BaseSquircleBorderRadius.lerp(
          a.borderRadius,
          borderRadius,
          t,
        )!,
  ...
  ShapeBorder? lerpTo(ShapeBorder? b, double t) {
    if (b is BaseSquircleBorder) {
      return BaseSquircleBorder(
        side: MoonSquicleBorderSide.lerp(side, b.side, t),
        borderRadius:
        BaseSquircleBorderRadius.lerp(borderRadius, b.borderRadius, t)!,
      );
    }
  ...
  Path _getPath(
      Rect rect,
      BaseSquircleBorderRadius radius, {
  ...
  @override
  BaseSquircleBorder copyWith({
    BorderSide? side,
    BaseSquircleBorderRadius? borderRadius,
  ...
  bool operator ==(Object other) {
    ...
    return other is BaseSquircleBorder &&
        other.side == side &&
