...
@immutable
class BaseAlertProperties extends ThemeExtension<BaseAlertProperties>
  ...
  @override
  BaseAlertProperties lerp(
    ThemeExtension<BaseAlertProperties>? other,
    double t,
  ) {
    if (other is! BaseAlertProperties) return this;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(
        DiagnosticsProperty("type", "BaseAlertProperties"),
      )
      ..add(
