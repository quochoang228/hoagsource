...
@immutable
class BaseTokenColors extends ThemeExtension<BaseTokenColors> with DiagnosticableTreeMixin {
  static const light = BaseTokenColors(
  ...
  static const dark = BaseTokenColors(
    piccolo: Color(0xFF5C33CF),
    hit: Color(0xFF1BD29A),
  ...
  @override
  BaseTokenColors lerp(ThemeExtension<BaseTokenColors>? other, double t) {
    if (other is! BaseTokenColors) return this;
