...
@immutable
class BaseTokenSizes extends ThemeExtension<BaseTokenSizes> with DiagnosticableTreeMixin {
  static const sizes = BaseTokenSizes(
    x6s: 2,
    x5s: 4,
    x4s: 8,
    x3s: 12,
  ...
  @override
  BaseTokenSizes lerp(ThemeExtension<BaseTokenSizes>? other, double t) {
    if (other is! BaseTokenSizes) return this;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty("type", "BaseTokenSizes"))
