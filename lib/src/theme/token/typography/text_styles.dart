...
@immutable
class BaseTokenTextStyles extends ThemeExtension<BaseTokenTextStyles> with DiagnosticableTreeMixin {
  static const _semiBold = FontWeight.w600;
  static const _semiBoldVariation = [FontVariation('wght', 600)];

  static const body = BaseTokenTextStyles(
  ...
  static const heading = BaseTokenTextStyles(
    textDefault: TextStyle(
      fontSize: 14,
  ...
  @override
  BaseTokenTextStyles lerp(ThemeExtension<BaseTokenTextStyles>? other, double t) {
    if (other is! BaseTokenTextStyles) return this;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty("type", "BaseTokenTextStyles"))
