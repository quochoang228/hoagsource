...
@immutable
class BaseAccordionColors extends ThemeExtension<BaseAccordionColors> with DiagnosticableTreeMixin {
  ...
  @override
  BaseAccordionColors lerp(
    ThemeExtension<BaseAccordionColors>? other,
    double t,
  ) {
    if (other is! BaseAccordionColors) return this;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty("type", "BaseAccordionColors"))
